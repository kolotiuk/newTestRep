 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ce(e){for(var t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}function Pe(e,t){if(e===t)return!0;var r=Object.keys(e),n=Object.keys(t),i=!0,a=!1,o=void 0;try{for(var s,u=r[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;if(!n.includes(c))return!1;var l=e[c],f=t[c];if(Le(l)&&Le(f)){if(!Pe(l,f))return!1}else if(l!==f)return!1}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}var h=!0,p=!1,d=void 0;try{for(var v,y=n[Symbol.iterator]();!(h=(v=y.next()).done);h=!0){var m=v.value;if(!r.includes(m))return!1}}catch(e){p=!0,d=e}finally{try{h||null==y.return||y.return()}finally{if(p)throw d}}return!0}function Le(e){return null!==e&&"object"==typeof e}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Jt="",Ot(new Fe("platform-logger",(function(e){return new yt(e)}),"PRIVATE")),Ot(new Fe("heartbeat",(function(e){return new Ht(e)}),"PRIVATE")),Nt(bt,wt,Jt),Nt(bt,wt,"esm2017"),Nt("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
e(o)(e(I).mark((function t(r,n){return e(I).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Cr(r,"POST","/v1/accounts:signInWithPassword",Tr(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Pn(e,t){return Ln.apply(this,arguments)}function Ln(){return(Ln=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ya(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Lt(),t=St(e,"auth");return t.isInitialized()?t.getImmediate():vr(e,{popupRedirectResolver:Ha,persistence:[ji,vi,mi]})}qa="Browser",Ot(new Fe("auth",(function(e,t){var r=t.options,n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),a=n.options,o=a.apiKey,s=a.authDomain;return function(e,t){lr(o&&!o.includes(":"),"invalid-api-key",{appName:e.name}),lr(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});var n={apiKey:o,authDomain:s,clientPlatform:qa,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:_n(qa)},i=new In(e,t,n);return function(e,t){var r=(null==t?void 0:t.persistence)||[],n=(Array.isArray(r)?r:[r]).map(dr);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(n,null==t?void 0:t.popupRedirectResolver)}(i,r),i}(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((function(e,t,r){e.getProvider("auth-internal").initialize()}))),Ot(new Fe("auth-internal",(function(e){var t=En(e.getProvider("auth").getImmediate());return new Ka(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Nt(Ja,Ga,
/**
 * @license
 * Copyright 2020 Google LLC
 *
